...
`meshtastic --set lora.region EU_868 --set security.admin_key base64:zhSuVvaywubn9tTUoVwRFaSYZEYH7joeLE0I0JY0hH0= --ch-index 2 --ch-set psk base64:cWpuRGhrQIZYbEYwUHNnTnlHRmNw-VUprQkNWaVVWZ3A= --ch-set name khmesh --ch-set module_settings.position_precision 32 --set-owner 'CSXX' --set-owner-short 'CSXX'`
